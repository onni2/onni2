...
**IS**: Ég hef ástríðu fyrir netöryggi, tölvukerfum og að skilja hvernig tækni
virkar á öllum stigum—frá vélbúnaði upp í hugbúnað. Ég er að læra skarpskyggnitækni
og stefni á feril í netöryggi. Mér finnst gaman að setja upp netþjóna, laga tölvur
og skilja kerfi til hlítar.

**EN**: I'm passionate about cybersecurity, computer systems, and understanding
how technology works at every level—from hardware to software. Currently learning
penetration testing and working toward a career in security. I enjoy setting up
servers, fixing computers, and deeply understanding systems.

---

## Færni / Skills

### Forritunarmál / Languages
...
🔐 **Netöryggi / Cybersecurity**
- Skarpskyggnitækni / Penetration Testing
- Netöryggi / Network Security
- CTF keppnir / CTF Competitions

🖥️ **Kerfi / Systems**
- Uppsetning og stjórnun netþjóna / Server setup & administration
- Lágstigsskilningur á tölvum / Low-level computer architecture
- Hástigsskilningur á kerfum / High-level system design
- Viðgerðir á tölvum og tækjum / Hardware troubleshooting & repair

🎮 **Annað / Other**
- Tölvuleikir / Gaming
- Tækniáhugi / Tech enthusiast
...
## Verkefni / Projects
- **Battle Simulator** - Bardagahermir í stíl við Pokemon (C++)
- **Random Map Generator** - Slembikortagerð fyrir borðspil (C)
- **DrRacket Game** - Leikur byggður á functional programming (Racket)
